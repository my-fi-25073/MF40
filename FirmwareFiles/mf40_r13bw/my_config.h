...
enum custom_value_id {
    // VIA 커스텀 값: LED 0/1/2/3/CAPS 이펙트
    id_custom_led_flags_0 = 1,
    id_custom_led_flags_1 = 2,
    id_custom_led_flags_2 = 3,
    id_custom_led_flags_3 = 4,
    id_custom_led_flags_4 = 5,
    // VIA 커스텀 값: LED 0/1/2/3/CAPS 인디케이터 선택
    id_custom_indicator_0 = 6,
    id_custom_indicator_1 = 7,
    id_custom_indicator_2 = 8,
    id_custom_indicator_3 = 9,
    id_custom_indicator_4 = 10,
};
#endif

// LED 인덱스 순서 사용: 0:B0(LED1), 1:B1(LED2), 2:B5(LED3), 3:B6(LED4), 4:A5(LED_CAPS)
