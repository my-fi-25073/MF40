...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,     KC_N,    KC_M,    LO_COMM, RA_DOT,  PT_SLSH, KC_RSFT, KC_RSFT,
        MO(4),   KC_LALT, LOWER,   LOWER,   KC_SPC,  KC_SPC,            KC_SPC,  RAISE,   RAISE,   MC_LCTL,          MO(4)
    ),

    [1] = LAYOUT(
        KC_ESC,  XXXXXXX, KC_7,    KC_8,    KC_9,    KC_0,     KC_GRV,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, KC_BSLS,
        MC_LCMD, XXXXXXX, KC_4,    KC_5,    KC_6,    XXXXXXX,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, KC_QUOT,
        KC_LSFT, XXXXXXX, KC_1,    KC_2,    KC_3,    XXXXXXX,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,  XXXXXXX, KC_RSFT, KC_RSFT,
        _______, KC_LALT, _______, _______, KC_SPC,  KC_SPC,            KC_SPC,  _______, _______, MC_LCTL,          _______
    ),

    [2] = LAYOUT(
        KC_TAB,  XXXXXXX, KC_F7,   KC_F8,   KC_F9,   KC_F10,   XXXXXXX, XXXXXXX, KC_INS,  XXXXXXX, OS_PSCR, KC_DEL,  KC_DEL,
        MC_LCMD, XXXXXXX, KC_F4,   KC_F5,   KC_F6,   KC_F11,   XXXXXXX, KC_RCTL, KC_RSFT, OS_LANG, KC_RGUI, XXXXXXX,
        KC_LSFT, XXXXXXX, KC_F1,   KC_F2,   KC_F3,   KC_F12,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RSFT, KC_RSFT,
        _______, KC_LALT, _______, _______, KC_SPC,  KC_SPC,            KC_SPC,  _______, _______, MC_LCTL,          _______
    ),

    [3] = LAYOUT(
        KC_ESC,  XXXXXXX, GO_UP,   XXXXXXX, VC_FLDR, VC_UFDR,  QK_RBT,  QK_BOOT, EE_CLR,  XXXXXXX, OS_CPATH, KC_DEL, KC_DEL,
        MC_LCMD, GO_LEFT, XXXXXXX, GO_RGHT, VC_FLDA, VC_UFDA,  WO_LEFT, XXXXXXX, XXXXXXX, WO_RGHT, XXXXXXX, XXXXXXX,
        KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, VS_BRCK,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RSFT, KC_RSFT,
        _______, KC_LALT, _______, _______, KC_SPC,  KC_SPC,            KC_SPC,  _______, _______, MC_LCTL,          _______
    ),
    ...
    [4] = LAYOUT(
        ...
        KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RSFT, KC_RSFT,
        _______, KC_LALT, _______, _______, KC_SPC,  KC_SPC,            KC_SPC,  _______, _______, MC_LCTL,          _______
    ),
